<x-app>
    <div class="gradient">
        <div class="pt-24">
            <div class="container text-black px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
                <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                    <p class="uppercase tracking-loose w-full">Jobs Listing.</p>
...
<div class="px-8">
    ...
    <style>
        .gradient {
            background: url('https://visie.net/content/images/2203h_sollicitatieverlofweb.png');
